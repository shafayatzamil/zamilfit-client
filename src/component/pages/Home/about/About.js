...
const About = () => {
  return (
    ...
    <div className="hero min-h-max bg-base-200">
      <div className="hero-content flex lg:flex-row justify-center ">
        <img
          src={trainer}
          className=" hidden md:block lg:block max-w-sm rounded-lg shadow-2xl"
          alt=""
        />
        <div>
          <h1 className="text-5xl font-bold text-slate-700">About</h1>
          ...
          <p className="py-6 text-slate-600 w-3/4">
            With the release of letraset sheet containing ipsum passenger and
            more recently with desktop publishing software like Aldus pageMaker
            including versions <br />I approach our Projects with strategic and
            create thinking. we partner with our clients to create big ideas and
            digital experience.And we spend each day doing so by sharpening the
